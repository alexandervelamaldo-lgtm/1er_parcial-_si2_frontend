...
export class TrackingService {
  ...
  // Último mensaje de chat recibido (cliente ↔ técnico). Los paneles del
  // detalle de solicitud lo consumen vía effect() y filtran por solicitud_id.
  readonly chatMessage = signal<ChatMessageEvent | null>(null);
